...
| カテゴリ       | 内容                                                   | 曜日                                |
| -------------- | ------------------------------------------------------ | ----------------------------------- |
| `shigoto`      | 仕事×AIあるある                                        | 月曜ローテーション枠（50%）         |
| `fukugyo`      | 副業の現実                                             | 月曜ローテーション枠（50%）         |
| `jitsuwa`      | 「実は〜してる」告白系                                 | 月曜ローテーション枠（50%）         |
| `question`     | 問いかけ・議論系                                       | **木曜固定** + 月曜ローテーション枠 |
| `suji`         | 「〇つのこと」リスト型                                 | 月曜ローテーション枠（50%）         |
| `nichijo`      | 日常のどうでもいいこと（通勤・食事・会社の謎ルール等） | 月曜ローテーション枠（50%）         |
| `url_reaction` | Zenn/Qiita 記事感想（URL付き）                         | 月曜固定枠（50%）                   |
