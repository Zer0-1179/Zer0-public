...
| 2026-05-01 | v1.3       | Google Trends 連動 `trend` カテゴリ（日曜10:00）追加                        |
| 2026-05-10 | v1.4       | url_reaction 記事概要 150→300文字に拡張                                     |
| 2026-05-29 | v1.5       | スタック名・Lambda関数名を `x-poster-zer0-0326` にリネーム                |
