...
- 記事に書かれていないことを事実として断定しない（感想・感情はOK）
- 1行目で読者を止めるフックを作る
- 「です・ます」禁止
- 100文字以内でコンパクトに
- 絵文字は最大1個
...
{avoid}
【良い例（構成・行数はバラバラでOK、毎回同じパターンにしないこと）】
---
実は会議中にAIに指示してた
...
---
---
半年くらい前から上司への返信ほぼAIに書かせてる
バレてないと思う

バレたとしてもまあいいかという気持ちもある
自分で考えた言葉じゃないのになんか通じてるのが不思議
{hashtag}
---
---
仕事でわからないことがあっても
...
【絶対禁止】
- AI / ChatGPT / Claude / Gemini / 生成AI / LLM / プロンプト / 自動化 → 一文字も出さない
- 副業・案件・収益・フリーランス → 一切触れない
- 「AIを使ったら〜」「AIに聞いたら〜」のような文脈も禁止
- テクノロジー系の話題（アプリ・ツール・システム）も不要
- ハッシュタグは付けない
- 100文字以内
- 「…」は1投稿に最大1回まで
- 綺麗にまとめない・余韻で終わる
