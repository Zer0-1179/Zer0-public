...
| 日付       | バージョン | 内容                                                                                                                                                           |
| ---------- | ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-13 | v0.26      | Fable追加指摘の中優先度7件を修正。役割誤用解消・reduced-motion対応・ブランド化404ページ・Cache-Control明示・競合比較表/中間CTA・確認完了ページの導線追加 |
| 2026-07-13 | v0.27      | Fable追加指摘の低優先度6件を修正。robots.txt/sitemap.xml・og:site_name・法務ページfavicon-16・CSPハッシュ化・execute-api favicon・FAQ2項目追加 |
| 2026-07-13 | v0.28      | LINE通知をメールと並列の選択肢として追加。LIFFで友だち追加とアカウント連携を1画面完結、collectorがLINE Messaging APIでもプッシュ送信 |
