...
| 2026-06-04 | v2.2       | 新テンプレート追加: cfn-cw-alarm-auto-update.yaml（advanced）/ cfn-cw-alarm-auto-update-basic.yaml（basic）。EC2/FSxリストア後にCloudWatch AlarmのディメンションIDを自動更新するLambda+EventBridge構成。上級版はConditionsでEC2/FSx監視を個別ON/OFF可能。AWS実機検証済み（2026-06-03）                                                                                                                                                                                                                                                                                                                                                                                                                |
