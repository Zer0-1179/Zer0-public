...
export const projects: Project[] = [
  ...
  },
  {
    ...
    pointsJa: [
      ...
      'OS別Googleマップ起動・XシェアURL・?course=Base64によるURL復元など、スマホ向けUXを徹底実装',
    ],
    pointsEn: [
      'Real-time 3-step loading indicator (GPS → weather → AI) reduces perceived wait time',
      'Claude Haiku generates feature tags, route summary, one-way/round-trip times, and return-route suggestions in one call',
      'Astro static PWA + CloudFront + S3 + Lambda: ~$0.40/month, ~$0.005 per request',
      'OS-adaptive Google Maps launch (Android/iOS/Web), X share, and ?course=Base64 URL restore for mobile-first UX',
    ],
