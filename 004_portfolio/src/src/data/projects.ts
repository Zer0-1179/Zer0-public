...
export const projects: Project[] = [
  ...
  },
  {
    ...
    descJa: 'AI活用術・会社員あるある系コンテンツを6カテゴリ＋固定2枠でローテーションしながら毎週月・木・日に自動投稿するBot。',
    descEn: 'Bot that auto-posts AI usage tips and office worker content on Mon/Thu/Sun across 6 rotating categories plus 2 fixed slots.',
    longDescJa: '仕事×AI・副業・実録・問いかけ・数字・日常の6カテゴリを直近7投稿で重複しないよう管理。木曜はquestion固定、月曜は50%でZenn/QiitaのAI記事感想をURL付きで投稿、日曜はGoogle Trendsと連動。カテゴリ別プロンプト設計で一貫した世界観を表現。',
    longDescEn: 'Manages 6 categories (Work×AI, Side hustle, Real stories, Questions, List posts, Daily life) without repeating within 7 posts. Thu: question fixed; Mon: 50% AI article reactions with URLs; Sun: Google Trends-linked posts. Category-specific prompts maintain consistent voice.',
    pointsJa: [
    ...
    pointsEn: [
      'Tracks 6-category history in SSM to prevent the same category appearing in 7 consecutive posts',
