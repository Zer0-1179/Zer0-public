...
export const projects: Project[] = [
  ...
  },
  {
    ...
    descJa: '「コピペで使えるAI活用の具体」を会社員目線で発信するXBot。プロンプトレシピ・実録・比較・失敗談の4カテゴリ＋副業・問いかけ＋固定2枠で構成。反応が伸びず現在は投稿を一時停止中。',
    descEn: 'X bot posting practical AI tips (copy-paste ready) for office workers. 4 practical categories plus side hustle, Q&A, and 2 fixed slots. Currently paused due to low engagement.',
    longDescJa: 'recipe・jissoku・hikaku・shippai・fukugyo・questionの6カテゴリを直近4投稿で重複しないよう管理。全投稿に「持ち帰れる具体」を1つ入れる実用路線。木曜はquestion固定、月曜は50%でZenn/QiitaのAI記事感想をURL付きで投稿、日曜はGoogle Trendsと連動。カテゴリ別プロンプト設計で一貫した世界観を表現。反応が伸びず現在は投稿を一時停止している。',
    longDescEn: 'Manages 6 categories (recipe, jissoku, hikaku, shippai, fukugyo, question) without repeating within 4 posts. Every post includes one take-home practical tip. Thu: question fixed; Mon: 50% AI article reactions with URLs; Sun: Google Trends-linked. Category-specific prompts maintain consistent voice. Currently paused due to low engagement.',
    pointsJa: [
