...
export const projects: Project[] = [
  ...
  },
  {
    ...
    pointsJa: [
      ...
      'DynamoDB IP別レートリミット・Nominatim waypointジオコード・?course=Base64 URLシェアなどスマホ向けUXを徹底実装',
    ],
    pointsEn: [
      ...
      'DynamoDB IP-based rate limiting, Nominatim waypoint geocoding with direction filter, and ?course=Base64 URL share for mobile-first UX',
    ],
