...
export const projects: Project[] = [
  ...
  },
  {
    ...
    pointsJa: [
      ...
      '残高÷空きスロット×90%の動的サイジングで、増資時に自動でポジションサイズが拡大',
      '24h未約定キャンセル・ブレイクイーブン移動・SSMによる状態管理で無人運用を実現',
    ],
    pointsEn: [
      'Triple AND filter (BTC 200EMA + Supertrend flip + Volume spike) drastically reduces false signals',
      'Transitions to trailing stop after TP1, capturing larger gains than a fixed TP2 in strong trends',
      'Dynamic sizing (balance ÷ open slots × 90%) automatically scales position size when capital grows',
      'Unattended operation via 24h cancel, breakeven move, and SSM-based state persistence',
    ],
