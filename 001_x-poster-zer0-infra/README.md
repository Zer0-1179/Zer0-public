...
| 日付       | バージョン | 内容                                                                                                                                                                                                                                                                                                         |
| ---------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2026-05-15 | v1         | 初版リリース                                                                                                                                                                                                                                                                                                 |
| 2026-05-20 | v1.1       | Qiita Atom形式パーサー追加。Atom形式未対応によりQiita記事が0件になる障害を修正                                                                                                                                                                                                                               |
...
| 2026-06-11 | v1.6       | 人間味改善（締め方4パターン・目安文字数の抽選、AIっぽい言い回し禁止）＋事実精度向上（記事本文グラウンディング・投稿前のBedrock事実検証パス）。同義ハッシュタグ重複排除・文末カット改善                                                                                                                       |
...
| 2026-06-22 | v1.9       | バグ修正＋ブラッシュアップ：スレッド途中エラー時も投稿済み分の履歴を保存（同記事の再選択ループ防止）、URLリプライに `tweet_id` ガード追加、naive datetime の astimezone 対策、CFn に `ReservedConcurrentExecutions: 1` 追加（EventBridge二重発火によるSSM競合防止）、不要docstring削除・整理                 |
