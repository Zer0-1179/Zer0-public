...
| 2026-05-14 | v1.1       | Google Maps + OSRM フォールバック二重ルーティング追加                 |
| 2026-05-15 | v1.2       | DynamoDB レートリミット（IP別・日別3回制限）追加                      |
| 2026-05-18 | v1.3       | URL短縮 + OGP SNSシェア機能（`/s/{id}`）追加                          |
| 2026-05-20 | v1.4       | スタイルタグ9種類 + 天気比較ウィジェット + 週間天気予報ストリップ追加 |
| 2026-05-25 | v1.5       | iOS Safariバックグラウンドリロード対応・popstate戻るジェスチャー対応  |
